...
SetScrollOffset:move.l		p_Level(a0),a1
				...
				move.w		d0,d1
				lsr.w		#3,d1				;l_X/8
				move.l		d1,pf_ByteOffset+BackGround
...
.MoveX			tst.w		d0
				...
				mulu.w		l_Width(a3),d3		;offset into map
...
.changeblocks	addq.w		#spriteblocks,d4
				...
				btst.b		#support,(a4,d6.l)
				bne.s		.NoFall_Ground
				btst.b		#support,(a4,d7.l)
				bne.s		.NoFall_Ground
...
.yup_next		move.w		d3,p_VelocityY(a0)
				move.w		d0,p_Y(a0)
				rts
*********************************************************************
*                                                                   *
